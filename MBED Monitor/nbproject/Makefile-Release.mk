...
${OBJECTDIR}/src/ConfigFile/ConfigFile.o: src/ConfigFile/ConfigFile.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ConfigFile/ConfigFile.o src/ConfigFile/ConfigFile.cpp

${OBJECTDIR}/src/ConfigFile/ConfigList.o: src/ConfigFile/ConfigList.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/ConfigFile
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ConfigFile/ConfigList.o src/ConfigFile/ConfigList.cpp
...
${OBJECTDIR}/src/MbedConnector.o: src/MbedConnector.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MbedConnector.o src/MbedConnector.cpp

${OBJECTDIR}/src/ReadingData.o: src/ReadingData.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ReadingData.o src/ReadingData.cpp

${OBJECTDIR}/src/TestMonitor.o: src/TestMonitor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TestMonitor.o src/TestMonitor.cpp
